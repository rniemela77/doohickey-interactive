<template>
    <div class="hand-drag">
        ...
        <div ref="trackpadElementRef" class="track-pad" :class="{ dragging: isDragging, disabled: disabled }"
            ...
            <svg v-if="!disabled" :style="{ opacity: !isDragging ? 1 : 0.1 }" class="hand-drag-icon" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg"
                stroke="#ffffff" stroke-width="0.00024000000000000003" transform="rotate(0)matrix(1, 0, 0, 1, 0, 0)">
